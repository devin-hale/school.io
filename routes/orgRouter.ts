...
router.put("/instance/:orgId/editinfo", verifyToken, orgController.edit_org_info);

router.put("/instance/:orgId/editcolor", verifyToken, orgController.edit_org_color);
